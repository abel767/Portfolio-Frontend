...
export function TabBar() {
  ...
  const tabs = [
    ...
    { id: "certificates", label: "Certs" },  // ← Changed from "Certificates"
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-center">
        {/* Tabs */}
        <div className="flex items-center gap-0 justify-between w-full max-w-md">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className="relative px-2 py-2 text-white/70 hover:text-white font-mono text-xs flex-1 min-w-0"
              >
